const faqs = [
  ...
  },
  {
    ...
    answer:
      "We focus on VS Code first, with JetBrains support in active development. Additional IDEs will follow, and your $1/month plan automatically unlocks new integrations.",
  },
  {
